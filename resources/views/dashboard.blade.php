...
@section('content')
    <div x-data="dashboardHandler()" class="space-y-8">
                        ...
                        @forelse ($recentPermohonans as $p)
                            <tr class="border-t hover:bg-gray-50">
                                ...
                                <td class="p-3">
                                    ...
                                    @endphp
                                    <span
                                        class="px-3 py-1 text-xs font-bold rounded-full {{ $statusClass[$p->status] ?? 'bg-gray-100 text-gray-800' }}">
                                        {{ $statusText }}
                                    </span>
                                </td>
                                <td class="p-3">
        ...
        <div x-show="showModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center"
            ...
            <div class="bg-white rounded-lg shadow-xl w-full max-w-2xl transform transition-all" x-show="showModal"
                ...
                <div class="px-6 py-4 border-b border-gray-200">
                    <div class="flex items-start justify-between">
                        ...
                        <button @click="closeModal()"
                            class="text-gray-400 hover:text-gray-600 rounded-full p-1 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        ...
                        <dl class="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                            ...
                            <div class="sm:col-span-1">
                                ...
                                <dd class="mt-1 text-base text-gray-900 font-semibold"
                                    x-text="detail.divisi?.nama_divisi ?? 'Belum ditentukan'"></dd>
                            </div>
                        </dl>
                    </div>
                </div>
