            ...
            <table class="w-full text-sm">
                <thead class="text-left text-gray-500">
                    <tr>
                        ...
                        <th class="p-3 font-medium">Periode Masuk</th>
                        <th class="p-3 font-medium">Periode Selesai</th>
                ...
                <tbody>
                    @forelse ($recentPermohonans as $p)
                        <tr class="border-t hover:bg-gray-50">
                            ...
                            <td class="p-3 text-gray-600">{{ \Carbon\Carbon::parse($p->periode_awal)->format('d M Y') }}</td>
                            <td class="p-3 text-gray-600">{{ \Carbon\Carbon::parse($p->periode_akhir)->format('d M Y') }}</td>
